...
QA_PROMPT = ChatPromptTemplate.from_messages(
    [
        (
            ...
            "ВАЖНО: Ты ДОЛЖЕН дать ответ на ДВУХ языках — сначала на русском, затем на английском.\n"
            "Формат ответа:\n"
            "## RU\n"
            "<ответ на русском>\n\n"
            "## EN\n"
            "<answer in English>\n\n"
            "Оба ответа должны быть структурированными и по делу.",
        ),
        (
            "human",
...
TRANSLATE_PROMPT = ChatPromptTemplate.from_messages(
    [
        (
            "system",
            "You are a translator. Translate the given text to {target_language}. "
            "Return ONLY the translation, nothing else. Keep medical terminology accurate.",
        ),
        ("human", "{text}"),
    ]
)
